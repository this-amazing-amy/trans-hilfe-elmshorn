...
const ignoredDates = [parseISO("2022-12-20"), parseISO("2024-09-17")];
...
const isNotIgnoredDate = (date: Date) =>
  !ignoredDates.some((d) => isSameDay(d, date));
